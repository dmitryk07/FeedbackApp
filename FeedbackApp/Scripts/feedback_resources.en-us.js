var resources = {
    get_pageTitle: function () { return "Feedback"; },
    ...
    get_noMessagesBufferListErrorText: function () { return "Messages buffer list does not exist or you do not have permission to perform this operation."; },

    get_completionMessageHeaderTitle: function () { return "Your message has been successfully sent."; },
    get_completionMessageText: function () { return "<span>To send another message click this</span>&nbsp;<a href='javascript:;' onclick='document.location.reload();'>link</a>."; },

    get_errorMessageHeaderTitle: function () { return "Sorry, something went wrong"; },
    get_reloadLinkTitle: function () { return "TRY AGAIN"; },

    get_sendButtonText: function () { return "Send"; },
};